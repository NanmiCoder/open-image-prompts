...
公开数据集包含 **16,663 条来源提示词**、**29,427 张图片**、**33,320 条翻译**、**194,029 条有效 v2 提示词标签**和 **185 个封闭视觉标签**。打标模型、回填工具、供应商配置、测试批次、错误日志以及其他打标过程记录均不在公开仓库中。以上数字由 `npm run verify:docs` 与 `data/public-corpus.json` 对账。
